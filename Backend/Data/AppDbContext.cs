    ...
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Camera>().HasData(
                ...
                new Camera { Id = 13, ModelNumber = "DS-2CD2187G2H-LISU", Description = "Camera - Hikvision 8 MP Smart Hybrid Light with ColorVu Mini Dome 2.8mm", Brand = "HikVision", Type = "Dome", Resolution = "8MP", Range = "30m", LensSize = "2.8mm", LensType = "Fixed Focal Lens", FovHorizontal = "102°", FovVertical = "55°", FovDiagonal = "120°", IrRange = "30m", Aperture = "F1.6", OperatingTemp = "–30°C to 60°C", Price = "$260–$340" },
                new Camera { Id = 14, ModelNumber = "DS-2DE2A404IW-DE3/W", Description = "Camera-Hikvision 4MP 4XOutdoor IR Wi-Fi Mini Dome PTZ DS-2DE2A404IW-DE3/W(S6)", Brand = "HikVision", Type = "PTZ", Resolution = "4MP", Range = "50m", LensSize = "4x Optical Zoom", LensType = "PTZ", FovHorizontal = "98°–30°", FovVertical = "51.16°-17.8°", FovDiagonal = "115.13°-36.32°", IrRange = "50m", Aperture = "F1.6", OperatingTemp = "–30°C to 60°C", Price = "$450–$650" },
                new Camera { Id = 15, ModelNumber = "DS-2SE7C432MWG-EB/26", Description = "Camera-HikVision 2.8mm Panoram Dome 32x PTZ TandemVu Camera", Brand = "HikVision", Type = "PTZ", Resolution = "4MP", Range = "150m", LensSize = "2.8mm", LensType = "PTZ", FovHorizontal = "57°–2.6°", FovVertical = "", FovDiagonal = "", IrRange = "150m", Aperture = "F1.5", OperatingTemp = "–30°C to 60°C", Price = "$1800–$2400" },
                new Camera { Id = 16, ModelNumber = "DS-2CD2766G2-IZS", Description = "Dome Camera 5MP 2.8-12mm Varifocal H.265+ IP67 IK10 HikVision (2.8-12mm)(C)(O-STD)", Brand = "HikVision", Type = "Dome", Resolution = "5MP", Range = "40m", LensSize = "2.8-12mm", LensType = "Motorised Varifocal", FovHorizontal = "99°–30°", FovVertical = "61°–17°", FovDiagonal = "128°–35°", IrRange = "40m", Aperture = "F1.6", OperatingTemp = "–30°C to 60°C", Price = "$350–$500" },
                ...
                new Camera { Id = 18, ModelNumber = "DS-2CD6365G1-IVS", Description = "Camera - Hikvision 6 MP Deepin View Fisheye Network 1.16 mm DS-2CD6365G1-IVS(1.16mm)", Brand = "HikVision", Type = "Fisheye", Resolution = "6MP", Range = "15m", LensSize = "1.16mm", LensType = "Fisheye", FovHorizontal = "360°", FovVertical = "", FovDiagonal = "", IrRange = "15m", Aperture = "F2.0", OperatingTemp = "–30°C to 60°C", Price = "$450–$650" },
