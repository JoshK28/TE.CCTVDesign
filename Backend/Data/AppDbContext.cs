    ...
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Camera>().HasData(
                ...
                new Camera { Id = 14, ModelNumber = "DS-2DE2A404IW-DE3/W", Description = "Camera Hikvision 4MP 4X Outdoor IR Wi-Fi Mini Dome PTZ", Brand = "HikVision", Type = "PTZ", Resolution = "4MP", Range = "50m", LensSize = "4x Optical Zoom", LensType = "PTZ", FovHorizontal = "98°–30°", FovVertical = "51.16°-17.8°", FovDiagonal = "115.13°-36.32°", IrRange = "50m", Aperture = "F1.6", OperatingTemp = "–30°C to 60°C", Price = "$450–$650" },
